...
tap(B, t + 90); at(t + 200, function() shot("pc_menu") end)
...
tap(SELECT, t + 600); at(t + 660, function() shot("cancelled") end)
...
at(t + 1020, function() local fh = io.open(dir .. "pc4_done.txt", "w"); fh:write("done"); fh:close() end)
