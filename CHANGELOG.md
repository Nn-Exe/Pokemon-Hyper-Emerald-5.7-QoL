...
- **Added** Rare Candy NPC in Petalburg City's Poké Mart: talking to him gives a Rare Candy, repeatably. The hack soft-resets on any mart list it does not own (`BuyMenuTryMakePurchase` jumps to hack code at `0x096FFF00`), so a candy shop was not possible. `patches/candynpc/`
