...
| **PC anywhere** — open the PC from any spot in the overworld: box storage, your own PC and the Hall of Fame. Uses the game's own menus without the "turn on/off" animation, so nothing is drawn onto the map. | Hold **B**, press **SELECT** | ![](docs/showcase/pc-anywhere.png) |
