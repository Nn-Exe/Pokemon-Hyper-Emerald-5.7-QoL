...
| **Rare Candy NPC** — a person in Petalburg City's Poké Mart hands out a Rare Candy every time you talk to him (the hack soft-resets on mart lists it does not own, so a candy *shop* was not possible). | Talk to him in the Petalburg Mart | |
